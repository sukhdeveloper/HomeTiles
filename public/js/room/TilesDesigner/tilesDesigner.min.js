...
(function() {
    ...
    function l(e) {
        ...
        function l(e) {
            window.TracingIdea && window.TracingIdea.HomeTiles && "function" == typeof window.TracingIdea.HomeTiles.addTile && "object" === ("undefined" == typeof e ? "undefined" : _typeof(e)) && window.TracingIdea.HomeTiles.addTile({
                id: e.id,
                custom: !0,
                name: e.name,
                width: e.width,
            ...
            function() {
                ...
                S.setWidth($("#edit-wrap svg").width()), S.setHeight($("#edit-wrap svg").height()), S.selection = !1, S.hoverCursor = "pointer", S.moveCursor = "pointer", S.defaultCursor = "pointer", S.on("mouse:down", a), S.on("mouse:move", i), S.on("mouse:up", n), S.on("object:moving", function(e) {
                    ...
                    "hexagon" === t.tile.shape ? e.target.set({
                        ...
                        left: g((e.target.left - 40) / 81) * 81 + 40,
                        top: g((e.target.top - 40) / 81) * 81 + 40,
                        lockMovementX : true,
                        lockMovementY : true 
                    })
                }), l()
                    ...
                    if (a.preventDefault(), e) { 
                        if (p.add(e.tile), "hexagon" === t.tile.shape) {
                            ...
                            T = new fabric.Image(n), T.set({
                                width: 81,
                                height: 81,
                                left: 81 * g((a.offsetX - 40) / 81) + 40,
                                top: 81 * g((a.offsetY - 40) / 81) + 40
                            })
                        }
    ...
    function g(e, t) {
        ...
        if (n) {
            ...
            l.addImage(r, "JPEG", 14 + g.left + 50, o += 16, g.width, g.height), l.setFontSize(16), l.text("PRODUCT APPROVAL FORM", 105, o += s + 10, "center"), l.text(e.name, 105, o += 10, "center");
            var c = 55;
            ...
            o += 5, l.setFontSize(9).setFontType("bold"), l.text("8in x 8in 8 5/8in", c - 5, o += 5), l.text("colors:", c - 5, o += 5),l.text(" ", 50, 185, ""),l.text("Please note that the pattern and colors indicated in this file are", 50, 190, "").setFontType('bold'),l.text("Please note that the pattern and colors indicated in this file are", 50, 190, "").setTextColor('#000000'), l.text(" computed generated and may vary from the actual handmade ", 50, 195, "").setTextColor('#000000'),l.text("product. We recommend proceeding with a physical sample prior", 50, 200, "").setTextColor('#000000'),l.text("to placing an order.", 50, 205, "").setTextColor('#000000'),l.text("To proceed with a formal quotation, please send us an email at", 50, 220, "").setTextColor('#0000ff'),l.text("inquire@machucatile.com", 50, 225, "").setTextColor('#000000'), l.text(" or send us a message on our ", 91, 225, "").setTextColor('#000000').setTextColor('#0000ff'),l.text("Facebook (www.facebook.com/machucatile) ", 50, 235, "").setTextColor('#000000'),l.text("or Instagram ", 120, 235, ""),l.text("(@machucatile) pages along with your selection. ", 50, 240, "").setTextColor('#000000'), l.text(i.text, c - 5 + 12, o), o += 15, l.text("", 14, o), o += 25, l.text("", 109, o), o += 25, l.rect(109, o - 2, 2, 2), l.text("", 109, o), l.text("www.machucatile.com       inquire@machucatile.com      Machucatile 2020", 105, 281, "center"), l.save(m.APP_COLORIZER_NAME + " - " + e.name + ".pdf")
        }
    }
                ...
                var a = $("<div/>").append(this.image).click(e),
                    i = $("<button>&times;</button>").click(function(e) {
                        e.stopPropagation(), $.get("/customtile/remove/" + t.id, function() {
                            a.remove(), window.TracingIdea && window.TracingIdea.HomeTiles && "function" == typeof window.TracingIdea.HomeTiles.removeTile && window.TracingIdea.HomeTiles.removeTile(t.id, !0)
                        })
                    });
